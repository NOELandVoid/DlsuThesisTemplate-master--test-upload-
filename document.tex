...
\newcommand{\documentTitle}{A Microcontroller-based System Used to Measure Different Weather Parameters Such As Temperature, Humidity, and Amount of Rainfall} % put tilde (~) between words to indicate non-breaking adjacent words
